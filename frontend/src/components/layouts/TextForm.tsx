...
export default function TextForm({ title, text, tag, setTitle, setText, setTag, addClass="" }: TextFormProps) {
    return (
        <div className={addClass + " grid grid-cols-1 md:grid-cols-[2fr_1fr] grid-rows-[auto_1fr] gap-4"}>
            ...
            <div className="input-group col-span-1 md:col-span-2">
                ...
                <Textarea
                    ...
                    className="resize-none mt-2 leading-relaxed overflow-y-auto scrollbar-custom max-h-[90vh] min-h-[300px] h-full bg-card [word-spacing:.2em]"
                />
            </div>
        </div>
    )
